 ...
 * Features nested orbits, complex shadows, and pulse effects using Framer Motion.
 */
    ...
    return (
        <div className={`relative flex items-center justify-center ${dimensions[size]} ${className}`}>
            ...
            <motion.div
                ...
                className={`${dimensions[size]} rounded-full bg-gradient-to-br from-purple-600 via-indigo-700 to-purple-900 border border-white/20 flex items-center justify-center relative z-10 shadow-2xl overflow-hidden`}
            >
